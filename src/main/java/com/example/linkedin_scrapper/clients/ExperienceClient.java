...
public class ExperienceClient {
    ...
    public String execRestClient(RestClient restClient, String linkedinId) {
        log.info("retrieving experience of linkedinId: {}", linkedinId);

        URI uri = URI.create("https://www.linkedin.com/voyager/api/graphql?includeWebMetadata=true&variables=(profileUrn:urn%3Ali%3Afsd_profile%3" + linkedinId + ",sectionType:experience,locale:pt_BR)&queryId=voyagerIdentityDashProfileComponents.8870d56cb9c3fc30759e093dff132b3e");
